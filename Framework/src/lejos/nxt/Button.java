...
public class Button implements ListenerCaller {
	...
	/**
	 * This method discards and events. In contrast to {@link #readButtons()},
	 ...
	 * which buttons have neem released.
	 * 
	 * @param timeout
	...
	/**
	 * Adds a listener of button events. Each button can serve at most 4
	 * listeners.
	 * 
	 * @param aListener
	 *            The new listener
	...
	private static int getButtons() {
		return Bridge.BRICK.readButtons();
	}
