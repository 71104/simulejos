...
public class Flash {
	...
	/**
	 * Maximum number of pages available to user flash memory. This value is
	 * obtained automatically from the firmware.
	 * 
	 */
	...
	static int flashReadPage(byte[] buf, int pageNum) {
		throw new NotImplementedException("Flash.flashReadPage");
	}

	static int flashWritePage(byte[] buf, int pageNum) {
		throw new NotImplementedException("Flash.flashWritePage");
	}

	static int flashExec(int pageNum, int size) {
		throw new NotImplementedException("Flash.flashExec");
	}
